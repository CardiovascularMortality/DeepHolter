...
class Model_All(nn.Module):
    ...
    def forward(self, x_list: Tensor, positional_list: Tensor,data_mask_list: Tensor, patientinfo: Tensor, timeinfo_list: Tensor, chara_list: Tensor,bc_only: bool=True) -> Tensor:

        device = x_list.device

        selected_idx = self.elector(x_list, data_mask_list)
